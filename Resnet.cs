...
public class Resnet
{
    internal static readonly string[] Labels = new[] {"tench",
                                                        "goldfish",
                                                        "great white shark",
                                                        "tiger shark",
                                                        "hammerhead shark",
    ...
    /// <summary>
    /// ResNet50 v2 image classification inference.
    /// Uses center-crop preprocessing with ImageNet mean and standard deviation
    /// normalization, then returns the top-10 predictions as text.
    /// </summary>
    ...
    public static string Detect(string model, ReadOnlySpan<byte> imageData, int width, int height)
    {
        ...
        // Extract RGB data, center-crop and resize it, then apply ImageNet normalization.
        var rgb = ImageProcessor.ExtractRgb(imageData, width, height);
        var mean = new[] { 0.485f, 0.456f, 0.406f };
        var stddev = new[] { 0.229f, 0.224f, 0.225f };
        float[] chw = ImageProcessor.CenterCropResizeNormalize(
            rgb, width, height, inputSize, inputSize, mean, stddev);

        // Build a [1, 3, 224, 224] NCHW tensor.
        ...
        // Select the top 10 predicted classes.
        var top10 = softmax
            .Select((x, i) => new Prediction { Label = Labels[i], Confidence = x })
